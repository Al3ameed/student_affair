...
<div class="header my-5 ">
    ...
    <h3 class="d-inline-block ml-3"> Manage Grades </h3>
...
<form action="{{ route("update_grade", $id) }}" method="post" >
    ...
    <div class="row mx-0 bg-blue p-3 py-5  d-flex position-relative gradeContainer">
        ...
        <div class="col-12 d-flex justify-content-end mb-5">
            <button type="button" class="btn btn-outline-danger mr-3" onclick="deleteGradeSections()"> Delete Grade Sections <i class="fa fa-minus" aria-hidden="true"></i> </button>
            <button type="button" class="btn btn-outline-success" onclick="addGradeSections()"> Add Grade Sections <i class="fa fa-plus" aria-hidden="true"></i> </button>
        </div>
    ...
    <div class="row col-12 mx-0 px-0 my-5 justify-content-center">
      <div class="col-md-6 col-12">
        <button class="btn btn-block btn-outline-primary"> Update Grades </button>
      </div>
    </div>
