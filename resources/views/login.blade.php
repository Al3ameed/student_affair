...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="text-center d-flex align-items-center justify-content-center" style="height: 100vh;">
        ...
        <form action="login" method="post" class="col-lg-4 col-md-6 col-sm-8 row flex-column mx-0 p-5"
                style="background-color: rgb(0 0 0 / 7%);border: 3px double #343a4030;">
            @csrf
